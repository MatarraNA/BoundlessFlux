...
public class TutRecipes extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        // AXE
        ShapedRecipeBuilder.shaped(ModItems.BOUNDED_AXE.get())
                .pattern("ww ")
                .pattern("ws ")
                .pattern(" s ")
                .define('s', Items.STICK)
        ...
        ShapedRecipeBuilder.shaped(ModItems.UPGRADE_LOOTING.get())
                ...
                .unlockedBy("coal", InventoryChangeTrigger.TriggerInstance.hasItems(Items.COAL))
                .save(consumer);
        ShapedRecipeBuilder.shaped(ModItems.UPGRADE_SILK.get())
                .pattern("ini")
                .pattern("nsn")
                .pattern("ini")
                .define('n', Tags.Items.NUGGETS_IRON)
                .define('i', Tags.Items.INGOTS_IRON)
                .define('s', Items.ELYTRA)
                .group(BoundlessFlux.MODID)
                .unlockedBy("coal", InventoryChangeTrigger.TriggerInstance.hasItems(Items.COAL))
                .save(consumer);
        ShapedRecipeBuilder.shaped(ModItems.UPGRADE_FORTUNE.get())
                .pattern("ini")
                .pattern("nsn")
                .pattern("ini")
                .define('n', Tags.Items.NUGGETS_IRON)
                ...
                .unlockedBy("coal", InventoryChangeTrigger.TriggerInstance.hasItems(Items.COAL))
                .save(consumer);
        ShapedRecipeBuilder.shaped(ModItems.UPGRADE_HAMMER.get())
                .pattern("ini")
                .pattern("nsn")
                .pattern("ini")
                .define('n', Tags.Items.NUGGETS_IRON)
                ...
                .unlockedBy("coal", InventoryChangeTrigger.TriggerInstance.hasItems(Items.COAL))
                .save(consumer);
        ShapedRecipeBuilder.shaped(ModItems.UPGRADE_ENERGY_GAIN.get())
                .pattern("ini")
                .pattern("nsn")
                .pattern("ini")
                .define('n', Tags.Items.NUGGETS_IRON)
                ...
                .unlockedBy("coal", InventoryChangeTrigger.TriggerInstance.hasItems(Items.COAL))
                .save(consumer);
        ShapedRecipeBuilder.shaped(ModItems.UPGRADE_FALLER.get())
                .pattern("ini")
                .pattern("nsn")
                .pattern("ini")
                .define('n', Tags.Items.NUGGETS_IRON)
