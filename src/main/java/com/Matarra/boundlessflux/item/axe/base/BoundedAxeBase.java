...
public class BoundedAxeBase extends AxeItem
{

    public BoundedAxeBase(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
                    ...
                    if( pUsedHand == InteractionHand.MAIN_HAND )
                    {
                        ...
                        if( offItem != null && offItem.getItem().equals(ModItems.BOUNDLESS_GEM.get()) )
                        {
                            ...
                            if( gemIsFull )
                            {
                                ...
                                ItemStack newItem = new ItemStack(ModItems.BOUNDLESS_AXE.get());
