...
public class ShurikenBoundless extends BoundlessBowBase {
    public ShurikenBoundless(Properties pProperties)
    {
        super(pProperties);
        this.customArrowItem = ModItems.SHURIKEN_ARROW.get();
    ...
    public void appendHoverText(@NotNull ItemStack stack, @Nullable Level world, @NotNull List<Component> tooltip, @NotNull TooltipFlag flag) {
        ...
        tooltip.add(Component.literal("Hira-Shuriken").withStyle(ChatFormatting.ITALIC, ChatFormatting.GOLD));
    }
}
