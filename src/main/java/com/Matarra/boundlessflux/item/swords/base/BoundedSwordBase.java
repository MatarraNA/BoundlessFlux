...
public class BoundedSwordBase extends SwordItem
{
    public BoundedSwordBase(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
    ...
    public boolean isDamageable(ItemStack stack) {
        return false; // this weapon cannot take damage
    }
                    ...
                    if( pUsedHand == InteractionHand.MAIN_HAND )
                    {
                        ...
                        if( offItem != null && offItem.getItem().equals(ModItems.BOUNDLESS_GEM.get()) )
                        {
                            ...
                            if( gemIsFull )
                            {
                                ...
                                // swap the players weapon with a boundless sword!
                                ItemStack newItem = new ItemStack(ModItems.FIRST_BOUNDLESS.get());
