...
import com.Matarra.boundlessflux.item.shovel.base.BoundedShovelBase;
...
public class BoundedShovel extends BoundedShovelBase
{

    public BoundedShovel(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
