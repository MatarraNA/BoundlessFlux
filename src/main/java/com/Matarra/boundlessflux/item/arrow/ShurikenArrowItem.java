...
public class ShurikenArrowItem extends ArrowItem
{
    public ShurikenArrowItem(Properties pProperties) {
        super(pProperties);
    }

    @Override
    public AbstractArrow createArrow(Level pLevel, ItemStack pStack, LivingEntity pShooter) {
        ShurikenArrow arrow = new ShurikenArrow(pShooter, pLevel, ModItems.SHURIKEN_ARROW.get());
        return arrow;
    }
    ...
    public boolean isInfinite(ItemStack stack, ItemStack bow, net.minecraft.world.entity.player.Player player) {
        ...
        return enchant <= 0 ? false : this.getClass() == ShurikenArrowItem.class;
    }
}
