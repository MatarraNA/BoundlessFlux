...
import com.Matarra.boundlessflux.entity.projectile.KunaiArrow;
...
public class KunaiArrowItem extends ArrowItem
{
    public KunaiArrowItem(Properties pProperties) {
        super(pProperties);
    }

    @Override
    public AbstractArrow createArrow(Level pLevel, ItemStack pStack, LivingEntity pShooter) {
        KunaiArrow arrow = new KunaiArrow(pShooter, pLevel, ModItems.KUNAI_ARROW.get());
        return arrow;
    }
    ...
    public boolean isInfinite(ItemStack stack, ItemStack bow, net.minecraft.world.entity.player.Player player) {
        ...
        return enchant <= 0 ? false : this.getClass() == KunaiArrowItem.class;
    }
}
