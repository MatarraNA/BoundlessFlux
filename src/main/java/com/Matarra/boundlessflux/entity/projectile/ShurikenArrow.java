...
public class ShurikenArrow extends AbstractArrow implements IBoundlessArrow
{
    ...
    public ShurikenArrow(EntityType<? extends AbstractArrow> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.referenceItem = ModItems.SHURIKEN_ARROW.get();
    }

    public ShurikenArrow(LivingEntity pShooter, Level pLevel, Item referenceItem) {
        super(ModEntities.SHURIKEN_ARROW.get(), pShooter, pLevel);
